...
function KakaoCallbackHandler({ code }: CallbackHandlerProps) {
...
export default function AuthCallbackPage() {
  ...
  if (!code) {
    return <ErrorUI error="인증 코드를 받지 못했습니다." />;
  }
  ...
  if (state?.startsWith("naver_")) {
    return <ErrorUI error="Naver 로그인은 아직 구현되지 않았습니다." />;
  }

  return <ErrorUI error="알 수 없는 OAuth 제공자입니다." />;
}
